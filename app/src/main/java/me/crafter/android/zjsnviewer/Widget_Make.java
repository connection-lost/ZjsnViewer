 ...
 */
public class Widget_Make extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager) {
        //Log.i("Widget_Make", "updateWidget()");
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget__make);
        ...
        appWidgetManager.updateAppWidget(new ComponentName(context, Widget_Make.class), views);
    }
}
